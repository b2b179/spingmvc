...
<html>
  ...
  <body>
    <div class="path"><a href="#">首页</a>  » 添加用户信息</div>
	<form id="inputForm"   action="${pageContext.request.contextPath}/users/addData" method="post">
		<table class="input">
			<tbody>
				<tr>
					<th>组别:</th>
				...
				<tr>
					...
					<td width="194">
						 <input  class="inp_fileToUpload" name="uploadFile" type="file" id="uploadFile" multiple="multiple"/> 
						 图片预览：<img src="" class="img_upload" id="img" style="display:none;width:30px;height:30px;"/> 
					</td>
					<td id="ageError"></td>
				</tr>
				<tr>
