...
<html>
  ...
  <body>
    <div class="path"><a href="#">首页</a>  » 添加组别信息</div>
	<form id="inputForm"   action="${pageContext.request.contextPath}/groups/addData" method="post">
		<table class="input">
			<tbody>
				<tr>
				...
				<tr>
					<th>&nbsp;</th>
					<td>
						<input type="hidden"  name="parent.groupId"  id="pgroupId" value="${data.parent.groupName}"/>					
						<input type="hidden"  name="user.userId"  id="userId" value="${data.user.groupName}"/>					
